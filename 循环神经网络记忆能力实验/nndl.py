...
class Accuracy(Metric):
    ...
    def update(self, outputs, labels):
        ...
        batch_correct = paddle.sum(paddle.cast(preds==labels, dtype="float32")).numpy().item()
...
def plot_training_loss_acc(runner, fig_name, fig_size=(16, 6), sample_step=10, loss_legend_loc="lower left", acc_legend_loc="lower left"):
    ...
    plt.subplot(1,2,2)
    #绘制评价准确率变化曲线
    plt.plot(dev_steps, runner.dev_scores, color='#f19ec2', linestyle="--", label="Dev accuracy")
